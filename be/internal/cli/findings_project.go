...
Examples:
  nrflo findings project-add mykey myvalue
  nrflo findings project-add k1:v1 k2:v2`,
...
Examples:
  nrflo findings project-get
  nrflo findings project-get mykey
  nrflo findings project-get -k k1 -k k2`,
...
Examples:
  nrflo findings project-append mykey newval
  nrflo findings project-append k1:v1 k2:v2`,
	Args: cobra.MinimumNArgs(1),
	RunE: func(cmd *cobra.Command, args []string) error {
		if err := RequireProject(); err != nil {
			return err
...
Examples:
  nrflo findings project-delete mykey
  nrflo findings project-delete k1 k2 k3`,
	Args: cobra.MinimumNArgs(1),
	RunE: func(cmd *cobra.Command, args []string) error {
		if err := RequireProject(); err != nil {
			return err
