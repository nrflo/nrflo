...
type TierTarget struct {
	Role              string
	OriginalSeedModel string // pre-retier seed default (post-000168/000210/000245 model-ref rewrites)
...
var TierMap = map[string]TierTarget{
	...
	"test-writer": {
		Role: "test-writer", OriginalSeedModel: "opus-5-5",
		Tier:             3,
		SystemTemplateID: "tier-t1-executor", IsWorker: true, GrantsDelegation: true,
	},
	"implementor": {
		Role: "implementor", OriginalSeedModel: "opus-5-5",
		Tier:             3,
		SystemTemplateID: "tier-t1-executor", IsWorker: true, GrantsDelegation: true,
	},
	"qa-verifier": {
		Role: "qa-verifier", OriginalSeedModel: "opus-5-5",
		Tier:             2,
