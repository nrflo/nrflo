...
{"key":"angles","schema":{"type":"object","required":["question","angles"],"properties":{"question":{"type":"string"},"angles":{"type":"array","minItems":3,"maxItems":6,"items":{"type":"object","required":["label","query"],"properties":{"label":{"type":"string"},"query":{"type":"string"},"rationale":{"type":"string"}}}}}},"example":{"question":"q","angles":[{"label":"broad","query":"q overview"},{"label":"recent","query":"q 2026"},{"label":"contrarian","query":"q criticism"}]}},
