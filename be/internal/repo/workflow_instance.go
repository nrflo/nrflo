...
func (r *WorkflowInstanceRepo) Create(wi *model.WorkflowInstance) error {
	...
	_, err := r.pool.Exec(`
		...
		wi.EndlessLoop, wi.StopEndlessLoopAfterIteration, wi.PurgeOnCompletion, wi.LaunchDepth, wi.ParentInstanceID, wi.SubworkflowDepth, wi.SubworkflowStarts, wi.PlanAutoApprove,
		now, now,
