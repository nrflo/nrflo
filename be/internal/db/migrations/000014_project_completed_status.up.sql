-- Add project_completed to status CHECK constraints for workflow_instances and agent_sessions.

PRAGMA foreign_keys = OFF;

-- 1. Rebuild workflow_instances with updated CHECK constraint
...
-- 2. Rebuild agent_sessions with updated CHECK constraint
