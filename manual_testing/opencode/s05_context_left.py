...
Expected result:
  ...
  - SKIP  agent ran successfully but the opencode async SQLite write was
          dropped (best-effort persistence under load).
  - FAIL  context_left NULL with non-pass result — telemetry not wired.
"""
