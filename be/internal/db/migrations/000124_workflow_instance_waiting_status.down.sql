-- Reverse rebuild: remove 'waiting' from workflow_instances status CHECK.
...
INSERT INTO workflow_instances_new (
    ...
    retry_count, parent_session, created_at, updated_at, skip_tags, worktree_path, branch_name,
