...
The Unix socket uses JSON-RPC line-delimited protocol. Supported methods: `findings.*`, `project_findings.*`, `agent.fail/continue/callback/context_update`, `workflow.skip/continue/fail`, `ws.broadcast`, `artifact.add/list/get`.
