...
`cli` (batch) was removed; all CLI providers run under `cli_interactive`.

| Provider | cli_interactive | api | script | take-control | plan mode | resume-session | real-time context telemetry | rate-limit events | low-consumption mode | MCP tools (api-mode) | script-mode |
|----------|-----------------|-----|--------|--------------|-----------|----------------|-----------------------------|-------------------|----------------------|----------------------|-------------|
| claude | ✅ | ✅ | N/A | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | N/A |
| codex | ✅ | ❌ | N/A | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ | N/A |
| opencode | ✅ | ❌ | N/A | ❌ | ❌ | ❌ | ✅ | ❌ | ✅ | ❌ | N/A |
