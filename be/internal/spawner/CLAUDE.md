...
| `opencode` | `OpencodeAdapter` | `provider/model` (auto-mapped) | Generated by CLI | ✓ (sqlite tail for context tracking) |
| `codex` | `CodexAdapter` | Model aliases with reasoning levels | Generated by CLI | ✓ (rollout JSONL tail; context tracking) |
