...
// Provider construction + credential resolution live in service.BuildAPIProvider
// (service/api_provider.go), which every wiring closure in this package calls
// directly; coverage is in service/api_provider_test.go.
