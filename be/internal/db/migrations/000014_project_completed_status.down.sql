-- Revert project_completed status: convert back to completed, rebuild tables without project_completed.

PRAGMA foreign_keys = OFF;

-- Convert any project_completed back to completed before rebuilding
UPDATE workflow_instances SET status = 'completed' WHERE status = 'project_completed';
UPDATE agent_sessions SET status = 'completed' WHERE status = 'project_completed';

-- 1. Rebuild workflow_instances without project_completed in CHECK
...
-- 2. Rebuild agent_sessions without project_completed in CHECK
