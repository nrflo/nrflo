...
- `X-Project` header is required for project-scoped endpoints; omitted for global endpoints (users, audit log, system agents, default templates, CLI models, API models, settings, docs).
