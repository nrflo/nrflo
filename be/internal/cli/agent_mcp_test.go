...
func TestDispatchMCP_Initialize(t *testing.T) {
	...
	resp := dispatchMCP(makeMCPReq(1, "initialize", ""), "ses1", "ins1", caller)
	if resp == nil {
...
func TestDispatchMCP_Initialize_IDPreserved(t *testing.T) {
	caller := &fakeMCPCaller{}
	resp := dispatchMCP(makeMCPReq("req-abc", "initialize", ""), "s", "i", caller)
	if resp.ID != "req-abc" {
...
func TestDispatchMCP_NotificationsInitialized(t *testing.T) {
	caller := &fakeMCPCaller{}
	resp := dispatchMCP(makeMCPReq(nil, "notifications/initialized", ""), "s", "i", caller)
	if resp != nil {
...
func TestDispatchMCP_ToolsList_HappyPath(t *testing.T) {
	...
	resp := dispatchMCP(makeMCPReq(2, "tools/list", ""), "ses1", "ins1", caller)
	if resp == nil {
...
func TestDispatchMCP_ToolsList_EmptyArray(t *testing.T) {
	...
	resp := dispatchMCP(makeMCPReq(3, "tools/list", ""), "s", "i", caller)
	if resp.Error != nil {
		t.Fatalf("unexpected error: %v", resp.Error)
	}
...
func TestDispatchMCP_ToolsList_CallerError(t *testing.T) {
	...
	resp := dispatchMCP(makeMCPReq(4, "tools/list", ""), "s", "i", caller)
	if resp.Error == nil {
...
func TestDispatchMCP_ToolsCall_HappyPath(t *testing.T) {
	...
	resp := dispatchMCP(makeMCPReq(5, "tools/call", `{"name":"my_tool","arguments":{"x":1}}`), "s", "i", caller)
	if resp == nil {
		t.Fatal("expected response")
	}
	if resp.Error != nil {
...
func TestDispatchMCP_ToolsCall_IsError(t *testing.T) {
	...
	resp := dispatchMCP(makeMCPReq(6, "tools/call", `{"name":"bad_tool"}`), "s", "i", caller)
	if resp.Error != nil {
		t.Fatalf("unexpected error: %v", resp.Error)
	}
	result := resp.Result.(map[string]interface{})
...
func TestDispatchMCP_ToolsCall_MissingName(t *testing.T) {
	caller := &fakeMCPCaller{}
	resp := dispatchMCP(makeMCPReq(7, "tools/call", `{"name":""}`), "s", "i", caller)
	if resp.Error == nil {
		t.Fatal("expected error")
	}
...
func TestDispatchMCP_ToolsCall_NilParams(t *testing.T) {
	...
	resp := dispatchMCP(req, "s", "i", caller)
	if resp.Error == nil {
...
func TestDispatchMCP_ToolsCall_NilArguments(t *testing.T) {
	...
	resp := dispatchMCP(makeMCPReq(9, "tools/call", `{"name":"tool_x"}`), "s", "i", caller)
	if resp == nil {
		t.Fatal("expected response")
	}
	if resp.Error != nil {
...
func TestDispatchMCP_ToolsCall_InvalidParams(t *testing.T) {
	caller := &fakeMCPCaller{}
	resp := dispatchMCP(makeMCPReq(10, "tools/call", `{not json`), "s", "i", caller)
	if resp.Error == nil {
		t.Fatal("expected error")
	}
	if resp.Error.Code != -32602 {
...
func TestDispatchMCP_ToolsCall_CallerError(t *testing.T) {
	...
	resp := dispatchMCP(makeMCPReq(11, "tools/call", `{"name":"tool_x"}`), "s", "i", caller)
	if resp.Error == nil {
		t.Fatal("expected error")
	}
	if resp.Error.Code != -32603 {
