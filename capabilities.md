...
_Generated by `python3 manual_testing/run_suite.py` at 2026-07-29T05:15:53Z (wall 639.6s, providers: engine, claude, codex, python, api, openai_api, console)._
...
| Scenario | engine | claude | codex | python | api | openai_api | console |
|----------|------|------|------|------|------|------|------|
