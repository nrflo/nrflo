-- Add user_interactive and interactive_completed to agent_sessions status CHECK constraint
...
CREATE TABLE agent_sessions_new (
    ...
    status                TEXT NOT NULL DEFAULT 'running'
        CHECK (status IN ('running', 'completed', 'failed', 'timeout', 'continued', 'project_completed', 'callback', 'user_interactive', 'interactive_completed')),
    result                TEXT
