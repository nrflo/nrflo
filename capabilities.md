...
_Generated by `python3 manual_testing/run_suite.py` at 2026-05-17T09:37:12Z (wall 1133.0s, providers: engine, claude, codex, gemini, opencode, python)._
...
| Scenario | engine | claude | codex | gemini | opencode | python |
|----------|------|------|------|------|------|------|
