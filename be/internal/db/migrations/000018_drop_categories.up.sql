-- Drop categories/category columns and strip skip_for from phase JSON.

-- 1. Simple drop: workflows.categories
ALTER TABLE workflows DROP COLUMN categories;

-- 2. Recreate workflow_instances without category column
...
-- 3. Recreate chain_executions without category column
