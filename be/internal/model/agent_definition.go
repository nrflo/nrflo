...
type AgentDefinition struct {
	...
	ProactiveRestartThresholdTokens *int      `json:"proactive_restart_threshold_tokens,omitempty"` // cli_interactive/codex only; NULL = inherit config proactive_restart_threshold_default, 0 = disabled
	Tag                             string    `json:"tag"`
