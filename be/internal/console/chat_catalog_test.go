...
func TestChatService_Catalog_ListsBuiltinProfiles(t *testing.T) {
	...
	if decider.DefaultEngine != "claude" || decider.DefaultModelID != "opus-5-5" || decider.DefaultEffort != "medium" || decider.ContextBudgetTokens != 30000 || !decider.RefineryDefault {
		t.Errorf("t0-decider profile option = %+v, want claude/opus-5-5/medium/30000/refinery-on", decider)
	}
