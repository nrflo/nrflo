...
// nrvappProvider implements apirun.ManifestProvider for a single manifest.
type nrvappProvider struct {
	deps deps
}
...
func New(
	...
	return &nrvappProvider{deps: deps{
		manifest:     manifest,
		runner:       runner,
		projectID:    projectID,
		sessionID:    sessionID,
...
func (p *nrvappProvider) Specs() []provider.ToolSpec {
...
func (p *nrvappProvider) Handler(name string) (apirun.ToolHandler, bool) {
...
func (h *manifestToolHandler) Invoke(ctx context.Context, env apirun.ToolEnv, input json.RawMessage) (string, bool, error) {
	...
	dispatch := &model.NrvappToolDispatch{
	...
	if h.d.hub != nil {
		h.d.hub.Broadcast(ws.NewEvent(ws.EventNrvappDispatchCompleted, h.d.projectID, "", "", map[string]interface{}{
	...
	if h.tool.Review && h.d.reviewRepo != nil {
		...
		if insertErr := h.d.reviewRepo.Insert(item); insertErr == nil && h.d.hub != nil {
			h.d.hub.Broadcast(ws.NewEvent(ws.EventNrvappReviewCreated, h.d.projectID, "", "", map[string]interface{}{
