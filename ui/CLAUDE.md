...
| `src/components/settings/` | Settings page sections: GlobalSettingsSection (low consumption mode toggle, session retention limit number input with tooltip), ProjectsSection (project CRUD), SystemAgentsSection (system agent definitions CRUD) |
