...
func TestApplyForProject_Idempotent(t *testing.T) {
	...
	seedTieringDef(t, pool, tieringDefSeed{projectID: "idem", workflowID: "feature", defID: "implementor", model: "opus-5-5"})
...
func TestApplyForProject_SkipsCustomizedConsultantHotfixNonStatic(t *testing.T) {
	...
	seedTieringDef(t, pool, tieringDefSeed{projectID: "skip", workflowID: "feature", defID: "qa-verifier", model: "opus-5-5", consultant: true})
	seedTieringDef(t, pool, tieringDefSeed{projectID: "skip", workflowID: "hotfix", defID: "implementor", model: "opus-5-5"})
	seedTieringDef(t, pool, tieringDefSeed{projectID: "skip", workflowID: "feature", defID: "implement-fanout", model: "opus-5-5", nodeRole: "planner"})
	...
	cases := []struct {
		...
		{"feature", "qa-verifier", "skipped-consultant", "opus-5-5"},
		{"hotfix", "implementor", "skipped-hotfix", "opus-5-5"},
		{"feature", "implement-fanout", "skipped-non-static", "opus-5-5"},
	}
	for _, c := range cases {
...
func TestApplyForProject_UnconfirmedDefSkipped(t *testing.T) {
	...
	seedTieringDef(t, pool, tieringDefSeed{projectID: "unconf", workflowID: "feature", defID: "implementor", model: "opus-5-5"})
...
func TestApplyForProject_WorkerTemplateAssignment(t *testing.T) {
	...
	roles := map[string]string{
		...
		"test-writer":    "opus-5-5",
		"implementor":    "opus-5-5",
		"qa-verifier":    "opus-5-5",
